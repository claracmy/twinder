      ...
      <div className="pure-g">
        <div className="pure-u-4-5 streams-card">
          <div className="pure-u-4-5 streams">
            ...
            <iframe className="frame-2" src={`https://player.twitch.tv/?channel=${this.props.streams[i].channel.display_name}&muted=true`} frameBorder="0" scrolling="no" allowFullScreen="true">
            </iframe>
